...
// Skill root is parent of lib directory
...
/**
 * Resolve a path relative to the skill root directory
 * @param {string} relativePath - Path relative to skill root
 * @returns {string} Absolute path
 */
export function getSkillPath(relativePath) {
  return resolve(SKILL_ROOT, relativePath);
}
...
export function log(message, level = 'info') {
  ...
  const logsDir = getSkillPath('logs');
...
export const skillRoot = SKILL_ROOT;
